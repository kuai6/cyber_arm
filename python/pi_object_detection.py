...
while True:
	...
	if detections is not None:
		...
		for i in np.arange(0, detections.shape[2]):
			...
			deep_val = deep_matr[centerX][centerY]
			
			# draw the prediction on the frame
			label = "{}: {:.2f}% {:d}".format(CLASSES[idx],
				confidence * 100, deep_val)
